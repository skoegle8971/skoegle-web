...
const handleSubmit = async (e) => {
  ...
  return (
    <Layout>
      <Head>
        <title>Join Us | Your Company Name</title>
        <meta name="description" content="Join our platform and discover amazing opportunities with Your Company Name" />
      </Head>
              ...
              <Card sx={{ flex: 1 }}>
                <CardContent sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <Typography paragraph>
                    Welcome to <strong>Your Company Name</strong>, where innovation meets excellence. We're dedicated to
                    providing cutting-edge solutions that transform industries and improve lives.
                  </Typography>
                  <Typography paragraph>
                    Founded in {process.env.NEXT_PUBLIC_FOUNDED_YEAR || '20XX'}, we've grown from a small startup to a market
